...
6. List the features I want to have.
...
11. Look into using react-native-config instead of `.env`/`react-native-dotenv`.
...
16. Consider getting rid of the `<Separator />` component.
